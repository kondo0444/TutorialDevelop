...
class UserControllerTest {
    ...
    void testGetList() throws Exception {
        ...
        assertEquals(targetUser.getId(), 1);
        assertEquals(targetUser.getName(),"キラメキ太郎");
        targetUser = users.get(1);
        assertEquals(targetUser.getId(), 2);
        assertEquals(targetUser.getName(),"キラメキ次郎");
        targetUser = users.get(2);
        assertEquals(targetUser.getId(), 3);
        assertEquals(targetUser.getName(),"キラメキ花子");
   }
}